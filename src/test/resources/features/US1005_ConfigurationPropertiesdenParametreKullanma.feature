...
Feature: US1005 Kullanici configuration.properties de yazilan datalari parametre olarak kullanir
  ...
  # ve o anasayfalara gittiginizi test edin
  # parametre olarak kullandigimiz kelimeler direk testte kullanılacak datalar olabilecegi gibi
  # configuration.properties de bulunan key ler de olabilir.Scenario: # Bu durumda stepdefinition da yolladigimiz key ile
